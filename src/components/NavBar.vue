...
<template>
    <nav>
            ...
            <div class=" mx-auto">
                <div class="flex justify-between">
                    ...
                    <div class="hidden md:flex items-center mr-3">
                        <router-link to="/login" class="menu-items font-sans">Login</router-link>
                        <router-link to="/register" class="menu-items font-sans">Register</router-link>
        ...
        <div class="md:hidden bg-[rgba(253,245,237,255)]" :class="{hidden: showMobileMenu}">
            ...
            <router-link to="/recipe" class="block py-1 px-2 hover:text-black text-black-400" @click="showMobileMenu = !showMobileMenu">Recipes</router-link>
            <router-link to="/marketplace" class="block py-1 px-2 hover:text-black text-black-400" @click="showMobileMenu = !showMobileMenu">Marketplace</router-link>
