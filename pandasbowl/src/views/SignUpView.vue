          ...
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form @submit.prevent="handleSubmit" class="space-y-4 md:space-y-6" action="#">
                  ...
                  <div>
                    ...
                    <!-- added the radio buttons for user type-->
                    <div class="flex items-start">
                        User Type:
                        <input type="radio" name="radio-1" class="radio" /> &nbsp; Individual
                        &nbsp;
                        <input type="radio" name="radio-1" class="radio" /> &nbsp; Home-Based Business
                    </div>
                    <div class="flex items-start">
